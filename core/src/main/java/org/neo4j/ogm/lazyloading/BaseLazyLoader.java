...
class BaseLazyLoader {
    ...
    protected BaseLazyLoader(Long id, Session session) {
        this.id = id;
        this.session = session;
    }

    public void validateSession(Session pSession) {
    ...
    protected <T> Collection<T> readRelation(FieldInfo fieldInfo) {
        ...
        Class<T> entityType = (Class<T>) DescriptorMappings.getType(fieldInfo.getTypeDescriptor());
